...
def _generate(prompt: str, task_type: str = "code_gen") -> str:
    """Use model_router for smart provider selection."""
    return model_router.smart_route(prompt, task_type=task_type)
...
JSON:"""
    ...
    try:
        raw = _generate(prompt, task_type="planning")
...
Code for {file_path}:"""
    ...
    try:
        code = _generate(prompt, task_type="code_gen")
...
Fixed code for {fix_path}:"""
        ...
        try:
            fixed = _generate(prompt, task_type="code_review")
